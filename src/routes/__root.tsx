...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Mosaico de Pitágoras" },
      {
        name: "description",
        content:
          "App educacional interativo: do Teorema de Pitágoras ao cosseno usado nos transformers.",
      },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "pt_BR" },
      { property: "og:site_name", content: "Mosaico de Pitágoras" },
...
function RootComponent() {
  // Obrigatório: as rotas filhas renderizam aqui. Remover o <Outlet /> quebra todas elas.
  return <Outlet />;
}
